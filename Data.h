...
uint8_tr Compressed_Track1[] PROGMEM = {
...
uint8_tr Compressed_Track2[] PROGMEM = {
  0x00, 0x4C, 
...
uint8_tr Compressed_Track3[] PROGMEM = {
  0x00, 0x50, 
...
uint8_tr Compressed_Track4[] PROGMEM = {
  0x00, 0x46, 
...
uint8_tr Compressed_Track5[] PROGMEM = {
  0x00, 0x32, 
...
uint8_tr Sin_Table128[5] PROGMEM = { 38, 66, 90, 107, 118 };  // cos[x] = Sin_Table128[4 - x];
uint8_tr *Tracks[5] = { Compressed_Track1, Compressed_Track2, Compressed_Track3, Compressed_Track4, 
Compressed_Track5 };
